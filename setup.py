...
def get_version():
    ...
    return (here / "src" / "venvmod" / "VERSION").read_text(encoding="utf-8").strip()
...
setup(
    ...
    description="Python venv extension using Modulefile",  # Optional
    ...
    # larger catalog.
    keywords="venv, modulefile",  # Optional
    ...
    install_requires=["packaging", "requests", "shellingham"],  # Optional
    ...
    package_data={  # Optional
        "venvmod": ["VERSION",
                    ...
                    "modulefiles_src/modules-5.6.0.tar.gz"],
    },
